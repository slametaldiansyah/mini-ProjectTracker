            ...
            <form id="myFormId" role="form" action="/projects/{{$project->id}}" method="post">
                ...
                <div class="card-body">
                    <div class="form">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <select id="contra" name="contract_id"
                                        ...
                                        onchange="myFunction()" {{ $project['contract_id'] ? 'disabled' : '' }}>
                        ...
                        <div class="d-flex justify-content-around">
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                    value="{{old('name', $project->name)}}" {{ $project['name'] ? 'disabled' : '' }}
                        ...
                        <div class="d-flex justify-content-around">
                            <div class="form-group col-4" id="hiddvolume" style="
                                    visibility:hidden">
                                ...
                                <input id="volume_use" type="number"
                                    ...
                                    onchange="math()" {{ $project['volume_use'] ? 'disabled' : '' }}>
                                @error('volume_use')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <table class=" table table-borderless d-flex justify-content-center" id="dynamicProgress">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="payment_percentage[]"
                                        ...
                                        placeholder="
                                        Enter % invoice" class="form-control"
                                        {{ $progress['payment_percentage'] || $progress['name_progress'] ? 'disabled' : '' }} />
                                </td>
                            </tr>
                            @endforeach
